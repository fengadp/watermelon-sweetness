...
#with c[0]:
#    label = "Sweet"
#    st.markdown("<h1 style='text-align: center; color: orange;'>${label}</h1>", unsafe_allow_html=True)
    #st.markdown("<h1 style='text-align: center; color: orange; <span id="label"></span></h1>", unsafe_allow_html=True)
#with c[1]:
    ...
    if numSamples == 3:
        ...
        with st.container(border=True):
            ...
            with col1[1]:
                ...
                #st.subheader(f":rainbow[{space} Watermelon is {result}]")
